if(UNIT_TEST){
    ...
    var creatFile = function(){
        ...
        uexFileMgr.writeFile(file, 0, "this is test data,this is test data,this is test data,this is test data",function(error){
              if(!error){
    ...
    var uexZipCase = {
        "zip":function(){
            creatFile();
            uexZip.zip(srcPath,zippedPath,function(error) {
                if(!error){
                    UNIT_TEST.log("压缩成功");
