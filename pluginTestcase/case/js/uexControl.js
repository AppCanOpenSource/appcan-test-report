if (UNIT_TEST) {
    var uexControlCase = {
        ...
        "openDatePickerWithConfig_1": function openDatePickerWithConfig(){
            var params = {
                initDate:{
                    year:2016,
                    month:3,
        ...
        "openDatePickerWithConfig_2": function openDatePickerWithConfig(){
            var params = {
                initDate:{
                    year:2016,
                    month:3,
        ...
        "openDatePickerWithConfig_3": function openDatePickerWithConfig(){
            var params = {
                initDate:{
                    year:2016,
                    month:3,
